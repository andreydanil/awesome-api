...
* API Actions
*** Be sure to download and use postman to call the api

** Get
*** Single user
URL: http://localhost/awesome-api/index.php/api/user/1

*** All users
URL:
http://localhost/awesome-api/index.php/api/all_users

** Put
URL: http://localhost/awesome-api/index.php/api/user

** Post 


** Delete
URL: http://localhost/awesome-api/index.php/api/user/3
